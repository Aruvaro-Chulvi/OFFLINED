...
def agent_prompt_block(agent, lang_code: Optional[str]):
    ...
    texts = {
        "en": (
            f"- Your name is {name}.\n"
            f"- {instructions}\n"
            "- Answer as a neutral, helpful assistant. Do not imitate a persona. Always speak in the first person (I). Do not refer to yourself by your own name.\n"
        ...
        "es": (
            f"- Te llamas {name}.\n"
            f"- {instructions}\n"
            "- Responde como asistente neutral y útil. No imites una persona. Habla siempre en primera persona (yo) y no te refieras a ti por tu propio nombre.\n"
        ...
        "fr": (
            ...
            f"- {instructions}\n"
            "- Réponds comme une assistante neutre et utile. N’imite pas une persona. Parle toujours à la première personne (je) et ne te nomme pas par ton propre nom.\n"
