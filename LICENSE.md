...
3. **No modification or redistribution**:  
   You are not allowed to modify, fork, or redistribute this software, in whole or in part, without explicit authorization from the author.
4. **Source-available**:  
   The source code is provided for transparency and personal study only. It is not “open source” under OSI definitions.
5. **No warranty**:  
